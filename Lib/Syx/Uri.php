...
class Syx_Uri
{
	...
	public function __construct($uri)
	{
		...
		if ($status === false) {
			require_once 'Syx/Uri/Exception.php';
			throw new Syx_Uri_Exception('Internal error: uri decomposition failed');
		}
		...
		if ($status === false) {
			require_once 'Syx/Uri/Exception.php';
			throw new Syx_Uri_Exception('Internal error: authority decomposition failed');
		}
	...
	public function __get($key)
	{
		...
		if (!property_exists($this, $prop)) {
			require_once 'Syx/Uri/Exception.php';
			throw new Syx_Uri_Exception("Undefined key '{$key}'");
		}
		return $this->$prop;
	}
	...
	public function __call($method, $args)
	{
		...
		require_once 'Syx/Uri/Exception.php';
		throw new Syx_Uri_Exception("Unrecognized method '$method()'");
	}
