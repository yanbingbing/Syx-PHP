 ...
 * @package    Syx_Captcha
 */
class Syx_Captcha_Image extends Syx_Captcha_Abstract
{
	...
	protected function _generateImage()
	{
		...
		if (empty($this->_fonts)) {
			require_once 'Syx/Captcha/Exception.php';
			throw new Syx_Captcha_Exception('No font file to use!');
		}
