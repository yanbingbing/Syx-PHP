...
require_once 'Syx/Request/Abstract.php';
 ...
 * @package   Syx_Request
 */
class Syx_Request_Http extends Syx_Request_Abstract
{
	/**
	 * REQUEST_URI
	 * @var string;
	...
	/**
	 * @param null|string|Syx_Uri $uri
	 */
	public function __construct($uri = null)
	{
		if (null !== $uri) {
			if (!$uri instanceof Syx_Uri) {
				require_once 'Syx/Uri.php';
				$uri = new Syx_Uri($uri);
			}
			$path = $uri->getPath();
			$query = $uri->getQuery();
	 ...
	 *
	 * @throws Syx_Request_Exception
	 * @return Syx_Request_Http
	 */
	public function setQuery($spec, $value = null)
	{
		if ((null === $value) && !is_array($spec)) {
			require_once 'Syx/Request/Exception.php';
			throw new Syx_Request_Exception('Invalid value passed to setQuery()');
		}
		if ((null === $value) && is_array($spec)) {
	...
	public function setPost($spec, $value = null)
	{
		if ((null === $value) && !is_array($spec)) {
			require_once 'Syx/Request/Exception.php';
			throw new Syx_Request_Exception('Invalid value passed to setPost()');
		}
		if ((null === $value) && is_array($spec)) {
			foreach ($spec as $key => $value) {
