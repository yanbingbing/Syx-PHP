 ...
 * @subpackage Adapter
 */
class Syx_Db_Adapter_Oci extends Syx_Db_Adapter
{
	...
	protected $_numericDataTypes = array(
		...
		'BINARY_DOUBLE'     => Syx_Db::FLOAT_TYPE,
		'BINARY_FLOAT'      => Syx_Db::FLOAT_TYPE,
		'NUMBER'            => Syx_Db::FLOAT_TYPE
	);
	 ...
	 *
	 * @param string|array|Syx_Db_Expr $ident The identifier or expression.
