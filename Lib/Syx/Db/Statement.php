 ...
 */
class Syx_Db_Statement implements IteratorAggregate
{
	/**
	 * @var Syx_Db_Adapter
	 */
	 ...
	 *
	 * @param Syx_Db_Adapter $adapter
	 * @param string         $sql
	 *
	 * @throws Syx_Db_Statement_Exception
	 */
	public function __construct($adapter, $sql)
	{
		try {
			...
			throw new Syx_Db_Statement_Exception($e->getMessage(), $e->getCode());
		}
	}
	...
	public function columnCount()
	{
		try {
			...
			require_once 'Syx/Db/Statement/Exception.php';
			throw new Syx_Db_Statement_Exception($e->getMessage(), $e->getCode(), $e);
		}
	}
