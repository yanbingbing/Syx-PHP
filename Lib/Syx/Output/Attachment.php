...
/**
 * Syx_Output_Attachment
 *
 * @category   Syx
 * @package    Syx_Output
 */
class Syx_Output_Attachment extends Syx_Output_Abstract
{
	/**
	 * Response object
	 *
	...
	/**
	 * @param Syx_Response_Http $response
	 * @param array             $options
	 */
	public function __construct(Syx_Response_Http $response, array $options = array())
	{
	...
	public function setFile($file)
	{
		if (!is_file($file) || !is_readable($file)) {
			...
			throw new Syx_Output_Exception("Cannot access file '$file'.");
		}
		$this->_file = $file;
		return $this;
	}
